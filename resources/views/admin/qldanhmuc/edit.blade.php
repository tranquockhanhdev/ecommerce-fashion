...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <form action="{{ route('admin.qldanhmuc.update', $category->id) }}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        @if ($category->image)
                            <img src="{{ asset($category->image) }}" alt="Ảnh danh mục"
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" id="status" class="form-control" required>
                            <option value="1" {{ old('status', $category->status) == 1 ? 'selected' : '' }}>Hiện
                            </option>
