                ...
                <div class="col-lg-3">
                    <div class="sidebar">
                        ...
                        <div class="blog__sidebar">
                            ...
                            <!-- Popular Tags  -->
                            <div class="blog__sidebar--item">
                                <h5 class="font-body--xxl-500">Tag Phổ Biến</h5>
                                <div class="blog__popular-tags">
                                    <a href="#"><span class="blog__popular-tags-item active">Healthy</span></a>
                                    <a href="#">
                                        <span class="blog__popular-tags-item">Low Fat</span></a>
                                    <a href="#"><span class="blog__popular-tags-item">Vegetarian
                                        </span></a>
                                    <a href="#">
                            ...
                            <div class="blog__sidebar--item">
                                ...
                                <div class="blog-gallery">
                                    ...
                                    <div class="blog-gallery__item">
                                        <a href="#" class="cards-ig">
                                            <div class="cards-ig__img">
                                                <img src="{{ asset('client/images/instagram//img-02-sm.png') }}"
                                                    alt="ig" />
                                                <div class="cards-ig__overlay">
                                                    <span>
                                                        <svg width="25" height="25" viewBox="0 0 25 25"
                                    ...
                                    <div class="blog-gallery__item">
                                        <a href="#" class="cards-ig">
                                            <div class="cards-ig__img">
                                                <img src="{{ asset('client/images/instagram//img-03-sm.png') }}"
                                                    alt="ig" />
                                                <div class="cards-ig__overlay">
                                                    <span>
                                                        <svg width="25" height="25" viewBox="0 0 25 25"
                                    ...
                                    <div class="blog-gallery__item">
                                        <a href="#" class="cards-ig">
                                            <div class="cards-ig__img">
                                                <img src="{{ asset('client/images/instagram//img-04-sm.png') }}"
                                                    alt="ig" />
                                                <div class="cards-ig__overlay">
                                                    <span>
                                                        <svg width="25" height="25" viewBox="0 0 25 25"
                                    ...
                                    <div class="blog-gallery__item">
                                        <a href="#" class="cards-ig">
                                            <div class="cards-ig__img">
                                                <img src="{{ asset('client/images/instagram//img-05-sm.png') }}"
                                                    alt="ig" />
                                                <div class="cards-ig__overlay">
                                                    <span>
                                                        <svg width="25" height="25" viewBox="0 0 25 25"
                                    ...
                                    <div class="blog-gallery__item">
                                        <a href="#" class="cards-ig">
                                            <div class="cards-ig__img">
                                                <img src="{{ asset('client/images/instagram//img-06-sm.png') }}"
                                                    alt="ig" />
                                                <div class="cards-ig__overlay">
                                                    <span>
                                                        <svg width="25" height="25" viewBox="0 0 25 25"
                                    ...
                                    <div class="blog-gallery__item">
                                        <a href="#" class="cards-ig">
                                            <div class="cards-ig__img">
                                                <img src="{{ asset('client/images/instagram//img-07-sm.png') }}"
                                                    alt="ig" />
                                                <div class="cards-ig__overlay">
                                                    <span>
                                                        <svg width="25" height="25" viewBox="0 0 25 25"
                                    ...
                                    <div class="blog-gallery__item">
                                        <a href="#" class="cards-ig">
                                            <div class="cards-ig__img">
                                                <img src="{{ asset('client/images/instagram//img-08-sm.png') }}"
                                                    alt="ig" />
                                                <div class="cards-ig__overlay">
                                                    <span>
                                                        <svg width="25" height="25" viewBox="0 0 25 25"
                            ...
                            <div class="blog__sidebar--item">
                                ...
                                <div class="blog__recent-product">
                                    <a href="single-blog.html" class="blog__recent-product__item">
                                        <div class="blog__recent-product__img-wrapper">
                                            <img src="{{ asset('client/images/blogs/blog-recent-1.png') }}"
                                                alt="products " />
                                        </div>
                                    ...
                                    <a href="single-blog.html" class="blog__recent-product__item">
                                        <div class="blog__recent-product__img-wrapper">
                                            <img src="{{ asset('client/images/blogs/blog-recent-2.png') }}"
                                                alt="products " />
                                        </div>
                                        <div class="blog__recent-product__item-info">
                                            <h5 class="font-body--lg-500">
                                    ...
                                    <a href="single-blog.html" class="blog__recent-product__item">
                                        <div class="blog__recent-product__img-wrapper">
                                            <img src="{{ asset('client/images/blogs/blog-recent-3.png') }}"
                                                alt="products " />
                                        </div>
                                        <div class="blog__recent-product__item-info">
                                            <h5 class="font-body--lg-500">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="row blog-list__content--desktop">
                        <div class="col-xl-6 custom-col">
                            <div class="cards-blog">
                                <div class="cards-blog__img-wrapper">
                                    <img src="{{ asset('client/images/blogs/blog-01.png') }}" alt="img-01" />
                                    <div class="date">
                                ...
                                <div class="cards-blog__info">
                                            ...
                                            <span>
                                                <svg width="20" height="21" viewBox="0 0 20 21" fill="none"
                                                    ...
                                                    <path
                                                        ...
                                                        stroke-linejoin="round" />
                                                    <path d="M5.83331 6.33301H5.84165" stroke="currentColor"
                                    ...
                                    <a href="single-blog.html" class="blog-title font-body--xl-500">Curabitur porttitor
                                        orci eget neque accumsan venenatis.
                                        Nunc fermentum.</a>
                        ...
                        <div class="col-xl-6 custom-col">
                            <div class="cards-blog">
                                <div class="cards-blog__img-wrapper">
                                    <img src="{{ asset('client/images/blogs/blog-02.png') }}" alt="img-01" />
                                    <div class="date">
                                        <h3 class="font-body--xxl-500">18</h3>
                                        <span class="font-body--sm-500">Nov</span>
                                    </div>
                        ...
                        <div class="col-xl-6 custom-col">
                            <div class="cards-blog">
                                <div class="cards-blog__img-wrapper">
                                    <img src="{{ asset('client/images/blogs/blog-03.png') }}" alt="img-01" />
                                    <div class="date">
                                        <h3 class="font-body--xxl-500">18</h3>
                                        <span class="font-body--sm-500">Nov</span>
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="cards-blog">
                                    ...
                                    <div class="cards-blog__info">
                                        ...
                                        <a href="single-blog.html" class="blog-title font-body--xl-500">Curabitur
                                            porttitor orci eget neque accumsan venenatis.
                                            Nunc fermentum.</a>
                                        <a href="single-blog.html">
                                            Read More
                                            <span>
