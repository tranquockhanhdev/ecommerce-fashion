                            ...
                            <div class="contact-form__content">
                                <div class="contact-form__content-group">
                                    <div class="contact-form-input">
                                        ...
                                        <input type="text" id="fname1" placeholder="Điền tên của bạn" name="firstname" require value="{{ Auth::user()->firstname }}" />
                                    </div>
                                    <div class="contact-form-input">
                                        <label for="lname2">họ và tên lót</label>
                                        <input type="text" id="lname2" placeholder="Nhập họ và tên lót của bạn" name="lastname" require value="{{ Auth::user()->lastname }}" />
                                    </div>
                                ...
                                <div class="contact-form-input">
                                    ...
                                    <input type="text" id="address" placeholder="Nhập địa chỉ của bạn" name="address" require value="{{ Auth::user()->address }}" />
                                </div>
                                ...
                                <div class="contact-form__content-group">
                                    ...
                                    <div class="contact-form-input">
                                        ...
                                        <input type="text" id="email" placeholder="Nhập Địa chỉ email" value="{{ Auth::user()->email }}" require />
                                    </div>
                                </div>
                                <div class="contact-form__content-group">
                                    <div class="contact-form-input">
                                        <label for="phone"> Phone </label>
                                        <input type="number" id="phone" placeholder="Nhập Số Điện Thoại" name="phone" value="{{ Auth::user()->phone }}" require />
                                    </div>
                                </div>
                            </div>
                        </form>
                        ...
                        <div class="bill-card__body">
                            ...
                            <div class="bill-card__memo">
                                ...
                                <div class="bill-card__memo-item subtotal">
                                    ...
                                    <span class="font-body--md-500">{{ number_format($total, 0, ',', '.') }} VNĐ</span>
                                </div>
                                <!-- Shipping  -->
