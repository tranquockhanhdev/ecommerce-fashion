...
@section('title', 'Danh Sách Yêu Thích | Synergy 4.0')
@section('content')
<!-- Shopping Cart Section Start   -->
<section class="shoping-cart section section--xl">
    <div class="container">
        <div class="section__head justify-content-center">
            <h2 class="section--title-four font-title--sm">Danh Sách Yêu Thích</h2>
        </div>
            ...
            <div class="cart-table">
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            @foreach($listWishlist as $listWishlist)
                            <tr>
                                <!-- Product item  -->
                                <td class="cart-table-item align-middle">
                                    <a href="product-details.html" class="cart-table__product-item">
                                        <div class="cart-table__product-item-img">
                                            <img src="{{ asset($listWishlist->product->images->first()->link) }}"
                                                alt="product" />
                                        </div>
                                        <h5 class="font-body--lg-400">{{$listWishlist->product->name}}</h5>
                                    </a>
                                </td>
                                <!-- Price  -->
                                <td class="cart-table-item order-date align-middle">
                                    <p class="font-body--lg-500">{{ number_format($listWishlist->product->price, 0, ',', '.') . ' VND' }}</p>
                                </td>
                                <!-- Stock Status  -->
                                <td class="cart-table-item stock-status align-middle">
                                    @if($listWishlist->status == 0)
                                    <span class="font-body--md-400 out">out of stock</span>
                                    @elseif($listWishlist->status == 1)
                                    <span class="font-body--md-400 in">in Stock</span>
                                    @endif
                                </td>
                                <td class="cart-table-item add-cart align-middle">
                                    <div class="add-cart__wrapper">
                                        <button class="button button--md">Thêm vào giỏ hàng</button>
            ...
            <div class="shoping-cart__mobile">
                <div class="shoping-card">
                    <div class="shoping-card__img-wrapper">
                        <img src="{{ asset('client/images/products/img-01.png') }} " alt="product-item" />
                    </div>
                ...
                <div class="shoping-card">
                    <div class="shoping-card__img-wrapper">
                        <img src="{{ asset('client/images/products/img-02.png') }} " alt="product-item" />
                    </div>
                    <h5 class="shoping-card__product-caption font-body--lg-400">
                        Fresh Orange
                ...
                <div class="shoping-card">
                    <div class="shoping-card__img-wrapper">
                        <img src="{{ asset('client/images/products/img-03.png') }} " alt="product-item" />
                    </div>
                    <h5 class="shoping-card__product-caption font-body--lg-400">
                        Chinese Cabbage
