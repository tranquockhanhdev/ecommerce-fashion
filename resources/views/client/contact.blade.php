...
@section('content')
                        ...
                        <div class="contact-form__contact-info--item">
                            <span class="icon">
                                <svg width="52" height="51" viewBox="0 0 52 51" fill="none"
                                    ...
                                    <path d="M11.6562 46.2188H40.3438" stroke="#2C742F" stroke-width="2"
                                    ...
                                    <path
                                        ...
                                        stroke="#2C742F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    <path
                            ...
                            <p>65 Đ. Huỳnh Thúc Kháng, Bến Nghé, Quận 1, Hồ Chí Minh</p>
                        </div>
                        <div class="contact-form__contact-info--item">
                            <span class="icon">
                                <svg width="52" height="51" viewBox="0 0 52 51" fill="none"
                ...
                <div class="col-lg-9">
                    <div class="contact-form-card">
                        ...
                        <p>
                            ...
                            trang của mình. Nếu bạn cần bất kỳ sự trợ giúp nào hoặc có câu hỏi về đơn hàng, sản phẩm, hoặc
                            dịch vụ, đừng ngần ngại liên hệ với chúng tôi. Chúng tôi luôn mong muốn đem đến cho bạn trải
                        ...
                        <form action="#">
                            ...
                            <div class="contact-form--input contact-form--input-area" id="subject">
                                <textarea name="subject" cols="auto" rows="auto" placeholder="Subjects"></textarea>
                            </div>
    ...
    <section class="section iframe">
        <div class="iframe__canvas">
            <iframe id="gmap_canvas" src="https://maps.google.com/maps?q=Alayaya&t=&z=15&ie=UTF8&iwloc=&output=embed"
