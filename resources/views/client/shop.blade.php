                    ...
                    <div class="row shop__product-items">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="cards-md cards-md--four w-100">
                                <div class="cards-md__img-wrapper">
                                    <a href="product-details.html">
                                        <img src="{{ asset('client/images/products/img-07.png') }}" alt="products" />
                                    </a>
                                    <!-- <span class="tag danger font-body--md-400">sale 50%</span> -->
                                    <div class="cards-md__favs-list">
                                        <span class="action-btn">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="cards-md cards-md--four w-100">
                                <div class="cards-md__img-wrapper">
                                    <a href="product-details.html">
                                        <img src="{{ asset('client/images/products/img-08.png') }}" alt="products" />
                                    </a>
                                    <!-- <span class="tag danger font-body--md-400">sale 50%</span> -->
                                    <div class="cards-md__favs-list">
                                        <span class="action-btn">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="cards-md cards-md--four w-100">
                                <div class="cards-md__img-wrapper">
                                    <a href="product-details.html">
                                        <img src="{{ asset('client/images/products/img-09.png') }}" alt="products" />
                                    </a>
                                    <!-- <span class="tag danger font-body--md-400">sale 50%</span> -->
                                    <div class="cards-md__favs-list">
                                        <span class="action-btn">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="cards-md cards-md--four w-100">
                                <div class="cards-md__img-wrapper">
                                    <a href="product-details.html">
                                        <img src="{{ asset('client/images/products/img-10.png') }}" alt="products" />
                                    </a>
                                    <!-- <span class="tag danger font-body--md-400">sale 50%</span> -->
                                    <div class="cards-md__favs-list">
                                        <span class="action-btn">
