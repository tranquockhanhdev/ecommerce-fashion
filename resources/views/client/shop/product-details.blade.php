                ...
                <div class="col-lg-6">
                    ...
                    <div class="products__content">
                        ...
                        <div class="products__content-info">
                            ...
                            <span class="dot">.</span>
                            <h3 class="font-body--md-500">Lượt xem: <span id="view-count">{{ $product->view }}</span></h3>
                            ...
                            <script>
                                $(document).ready(function() {
                                    ...
                                    function updateViewCount() {
                                        $.ajax({
                                            url: `/product/${productId}/views`,
                                            method: 'GET',
                                            success: function(data) {
                                                $('#view-count').text(data.view);
                                            },
                                            error: function(err) {
                                                console.error(err);
                                            }
                            ...
                            <span class="dot">.</span>
                            <h3 class="font-body--md-500">Bình luận: <span id="comment-count">{{ $commentCount }}</span>
                            </h3>
                        </div>
                        <script src="{{ asset('js/like-view-rating.js') }}"></script>
                        <div class="">
                            <h5>
                    ...
                    <div class="products__content">
                        <div class="products__content-action">
                            ...
                            <!-- fav  -->
                            @if (auth()->check())
                                <!-- Nút yêu thích khi người dùng đã đăng nhập -->
                                <button class="button-fav products__content-action-item"
                                    data-product-id="{{ $product->id }}">
                                    <svg width="20" height="20" viewBox="0 0 20 20"
                                        fill="{{ $isFavourite ? 'blue' : 'none' }}" stroke="currentColor"
                                        stroke-width="1.5">
                                        <path
                        ...
                        <script>
                            document.addEventListener('DOMContentLoaded', function() {
                                ...
                                // Nếu người dùng đã đăng nhập, hiển thị nút yêu thích
                                if (isLoggedIn) {
                                    favButton.style.display = 'inline-block'; // Hoặc 'block' tùy thuộc vào kiểu hiển thị của bạn
                                } else {
                                    favButton.style.display = 'none'; // Ẩn nút yêu thích khi chưa đăng nhập
                                }
                                // Gửi yêu cầu Ajax để thêm/xóa sản phẩm yêu thích
                                fetch(`/toggle-favorite/${productId}`, {
                                    ...
                                    .then(data => {
                                        ...
                                        // Thay đổi icon yêu thích nếu cần
                                            ...
                                            <div class="products-tab__feedback-content-top">
                                                <div class="user-details">
                                                    ...
                                                    <div class="user-details__info">
                                                        <h2 class="user-name">{{ $comment->lastname }}
                                                            {{ $comment->firstname }}
                                                        </h2>
                                                    ...
                                                    document.addEventListener('DOMContentLoaded', function() {
                                                            ...
                                                            fetch(`/products/${productId}/comments`)
                                                                ...
                                                                .then((data) => {
                                                                    ...
                                                                    data.comments.forEach((comment) => {
                                                                        ...
                                                                        li.textContent =
                                                                            `${comment.content} - ${comment.rating}★ by ${comment.account.firstname} ${comment.account.lastname}`;
                                                        ...
                                                        commentForm.addEventListener('submit', function(e) {
                                                            ...
                                                            fetch('/comments', {
                                                                    ...
                                                                    body: JSON.stringify({
                                                                        product_id: productId,
                                                                        account_id: 1, // Replace with logged-in user ID
                                                                        content: content,
                                                                        rating: rating,
                                                                    }),
                                                                })
                                ...
                                <div class="cards-md__info d-flex justify-content-between align-items-center">
                                    <a href="product-details.html" class="cards-md__info-left">
                                        ...
                                        <div class="cards-md__info-price">
                                            <span class="font-body--lg-500">Giá:
...
@section('js')
        ...
        $(document).on('click', '.button-fav', function(e) {
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    ...
                    alert('Có lỗi xảy ra: ' + xhr.responseJSON.message); // Hiển thị lỗi từ server
                }
            });
        });
    </script>
    ...
    <script>
        function updateQuantity() {
            // Gọi AJAX với slug
            $.get(`/shop/{{ $productSlug }}/quantity`, function(data) {
