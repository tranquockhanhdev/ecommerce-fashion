                ...
                <div class="products__content">
                    <div class="products__content-brand">
                        <div class="social-site">
                            <h2 class="font-body--md-400">Chia Sẻ:</h2>
                ...
                <div class="products__content">
                    <div class="products__content-action">
                        <div class="counter-btn-wrapper products__content-action-item">
                            ...
                            <input type="number" id="counter-btn-counter" class="counter-btn-counter" min="0" max="1000"
                                placeholder="0" />
                        ...
                        @if(auth()->check())
                            ...
                            <button class="button-fav products__content-action-item" data-product-id="{{ $product->id }}">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="{{ $isFavourite ? 'blue' : 'none' }}"
                                    ...
                                    <ul>
                                        @php
                                            ...
                                            foreach ($productDetail as $detail) {
                                                $colorName = $detail->color->color_name ?? 'Màu sắc không xác định';
                                                $groupedProducts[$colorName][] = $detail->size->size_name;
                                            }
                                        @endphp
                                        ...
                                        <div class="products-tab__feedback-content-top">
                                            <div class="user-details">
                                                ...
                                                <div class="user-details__info">
                                                    <h2 class="user-name">{{ $comment->lastname }} {{ $comment->firstname }}
                                                    </h2>
                                                        ...
                                                        fetch(`/products/${productId}/comments`)
                                                            ...
                                                            .then((data) => {
                                                                ...
                                                                data.comments.forEach((comment) => {
                                                                    ...
                                                                    li.textContent = `${comment.content} - ${comment.rating}★ by ${comment.account.firstname} ${comment.account.lastname}`;
