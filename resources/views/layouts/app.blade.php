...
<head>
    ...
    <title>Homepage | Synergy 4.0</title>
            ...
            <div class="container">
                <div class="header__center-content">
                    ...
                    <div class="header__cart">
                        ...
                        <div class="header__cart-item">
                            <a href="user-dashboard.html" class="icon user-icon">
                ...
                <div class="header__mobile-top">
                    ...
                    <ul class="header__mobile-menu">
                        <li class="header__mobile-menu-item active">
                            <a href="home-05.html" class="header__mobile-menu-item-link">
                                Trang Chủ
                            </a>
                        </li>
                        ...
                        <li class="header__mobile-menu-item">
                            <a href="about.html" class="header__mobile-menu-item-link">Giới Thiệu</a>
                        </li>
                        <li class="header__mobile-menu-item">
                            <a href="contact.html" class="header__mobile-menu-item-link">Liên Hệ</a>
                        </li>
                    </ul>
                </div>
            </div>
